...
- **[Geometry Service](geometry_service/index.md)** — Geometry access library
- **[Field Service](field_service/index.md)** — Magnetic field map library
- **[Data Model](data-model/index.md)** — Event data classes
